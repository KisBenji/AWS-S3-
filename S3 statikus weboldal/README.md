...
A `Bucket policy`-t konfiguráljuk és JSON fájl-t töltünk fel. Itt már látszik a Bucket neve is és a korlátozások is, hogy mi engedélyezett.
...
Ezután feltöltöttem egy `s3-index.html` és `s3-error.html` fájlt a Bucket-be.
...
Ezután elérhetővé `Enable` tesszük a Static website hosting lehetőséget és megadjuk a korábban feltölött fájlok nevét.
